...
class _MapsState extends State<Maps> {
  ...
  List<places.Prediction> predictions = [];
      ...
      body: Center(
        child: Stack(children: <Widget>[
          GoogleMap(
            ...
            polylines: _polyLines.isNotEmpty && _polyLines.first.points != null
                ? _polyLines
                : null,
          ),
          Positioned(
            ...
            child: Container(
              ...
              child: TextField(
                onChanged: (value) async {
                  var autoCo = await googleMapsPlaces
                      .autocomplete(value, components: [
                    directions.Component(directions.Component.country, 'usa')
                  ]);
                  setState(() {
                    predictions = autoCo.predictions;
                  });
                },
                cursorColor: Colors.black,
                            ...
                            itemBuilder: (BuildContext context, int index) =>
                              ...
                              children: <Widget>[
                                ...
                                ListTile(
                                  ...
                                  onTap: () async {
                                    var placeDetails = await googleMapsPlaces
                                        .getDetailsByPlaceId(
          ...
          Padding(
            ...
            child: Align(
              ...
              child: RaisedButton(
                onPressed: () async {
                  DatabaseService(uid: widget.uid).updateUserStatus(!_online);
                  setState(() {
                    _online = !_online;
